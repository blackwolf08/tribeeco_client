...
class CreateEvent extends Component {
  ...
  componentDidMount() {
    axios
      ...
      .then(res => {
        const { hosts, tags, ...rest } = res.data;
        let hosts_ = [];
        let cohosts = [];
        let tags_ = [];

        if (tags != null) tags_ = tags;
        ...
        this.setState({
          eventData: { hosts: hosts_, cohosts, tags: tags_, ...rest },
          eventId: res.data.id,
          previewURL: res.data.image,
          dataLoaded: true
        });
      })
      .catch(err => {
    ...
    if (eventCreated)
      return (
        <div className="text-center mt-4">
          <h3 className="font-weight-bold mb-3">Event Edited</h3>
      ...
      <Formik
        ...
        onSubmit={values => {
          ...
          axios
            ...
            .then(res => {
              this.uploadImage(this.state.eventId);
          ...
          <Form className="event-form p-3">
            ...
            <div className="row mt-4 mb-3">
              ...
              <div className="col-md-6 form-group row">
                ...
                <div className="col-sm-8 d-flex p-0 align-items-start">
                  <FieldArray
                    name="cohosts"
                    render={arrayHelpers => (
                      <div className="">
            ...
            <div className="d-flex justify-content-end align-items-center mt-4">
              {draftSaved && (
                <span className="text-success">Saved as a draft</span>
              )}
              <button
                type="button"
