...
class Autocomplete extends React.Component {
  ...
  changeHandler = selectedMember => {
    if (selectedMember) {
      ...
      this.props.onChange("currentMember.id", selectedMember.id);
      this.props.onChange("currentMember.fullname", selectedMember.fullname);
    }
  };
  ...
  clearSelection = () => {
    ...
    this.props.onChange("currentMember.id", "");
    this.props.onChange("currentMember.fullname", "");
  };
